...
const Footer = () => {
    return (
        <footer className="bg-black text-white py-8 px-6  w-full h-[331px] mt-10">
            <div className="w-[1372px] h-[213px] flex justify-around ">
                {/* Column 1 */}
                <div>
                ...
                <div className="flex justify-start lg:justify-end items-start gap-4">
                    <CiTwitter className="text-lg cursor-pointer hover:text-gray-400" />
                    <CiFacebook className="text-lg cursor-pointer hover:text-gray-400" />
                    <TfiYoutube className="text-lg cursor-pointer hover:text-gray-400" />
                    <FaInstagramSquare className="text-lg cursor-pointer hover:text-gray-400" />
                </div>
            </div>

            {/* Bottom Section */}
            <div className=" w-[1372px] h-[62px] mt-8 flex flex-wrap justify-between items-center text-xs text-gray-400">
