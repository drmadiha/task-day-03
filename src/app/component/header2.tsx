...
//   //         localCartItem.setItem(`cart`, JSON.stringify(localCartItem))
//   //       }
//   //     } else {
//   //       setCartNumber(0)
//   //       setCartItem([props.cartData])
...
// //         {/* Favorite and Cart Icons */}
// //         <Link href="/contactus"> <CiHeart className="text-black text-[24px] hover:text-gray-700" /></Link>
// //         <Link href=""><HiOutlineArchiveBox className="text-black text-[24px] hover:text-gray-700" />({cartNumber ? cartNumber : 0})</Link>
// //       </div>
// //     </div>
// //   </div>
